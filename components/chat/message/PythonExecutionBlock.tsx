      ...
      >
        <div className="border-t border-border-base bg-bg-panel -mx-4 -my-3">
            <div className={`${isOutputDocked ? 'border-b border-border-base' : ''}`}>
                <div className="px-3 py-1 bg-bg-element text-[10px] text-text-tertiary uppercase tracking-wider font-bold flex justify-between items-center">
                    <span>Input</span>
                </div>
            ...
            {isOutputDocked && (
                <div className="animate-fade-in">
                    <div className="px-3 py-1 bg-bg-element text-[10px] text-text-tertiary uppercase tracking-wider font-bold border-b border-border-base">Output</div>
