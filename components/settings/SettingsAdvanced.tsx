...
const SettingsAdvanced: React.FC<SettingsAdvancedProps> = memo(({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative p-4 rounded-e-xl rounded-s-md border border-border-base border-s-4 border-s-tint-teal-border bg-bg-panel">
      ...
      <div className="relative p-4 rounded-e-xl rounded-s-md border border-border-base border-s-4 border-s-tint-red-border bg-bg-panel">
