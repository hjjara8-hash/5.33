...
const SettingsToolsContext: React.FC<SettingsToolsContextProps> = memo(({
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="relative p-4 rounded-e-xl rounded-s-md border border-border-base border-s-4 border-s-tint-indigo-border bg-bg-panel">
      ...
      <div className="relative p-4 rounded-e-xl rounded-s-md border border-border-base border-s-4 border-s-text-muted bg-bg-panel">
      ...
      {/* Files Card - Orange */}
      <div className={`relative p-4 rounded-e-xl rounded-s-md border border-border-base border-s-4 border-s-tint-orange-border bg-bg-panel flex items-center justify-between ${isExternalModeActive ? 'opacity-50 pointer-events-none' : ''}`}>
        <div className="flex items-center">
      ...
      <div className="relative p-4 rounded-e-xl rounded-s-md border border-border-base border-s-4 border-s-tint-pink-border bg-bg-panel">
